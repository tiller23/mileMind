      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 w-full px-4 py-3 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 hover:border-gray-400 disabled:opacity-50 transition-all"
          >
