...
down_revision: Union[str, Sequence[str], None] = 'a4d58c24e1dc'
...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('athlete_profiles', sa.Column('plan_duration_weeks', sa.Integer(), nullable=False, server_default='12'))
